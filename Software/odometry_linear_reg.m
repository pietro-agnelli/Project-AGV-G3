...
Uodometry = diag([sigma_zx sigma_xz sigma_theta_60])

% Expressing uncertainty in mm while odometry is performed in m
writematrix(Uodometry*1000,"../Tests/20231201/04_results/Uodometry.csv")
